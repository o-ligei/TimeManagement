...
public class SpeechRecognizeActivity extends Activity implements View.OnClickListener {
    ...
    private static final String TAG = SpeechRecognizeActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIat = SpeechRecognizer.createRecognizer(SpeechRecognizeActivity.this, mInitListener);

        // 初始化听写Dialog，如果只使用有UI听写功能，无需创建SpeechRecognizer
        // 使用UI听写功能，请根据sdk文件目录下的notice.txt,放置布局文件和图片资源
        mIatDialog = new RecognizerDialog(SpeechRecognizeActivity.this, mInitListener);

//        mSharedPreferences = getSharedPreferences(IatSettings.PREFER_NAME,
//                Activity.MODE_PRIVATE);
        mToast = Toast.makeText(this, "", Toast.LENGTH_SHORT);
        mResultText = ((EditText) findViewById(R.id.iat_result));
//        showContacts = (EditText) findViewById(R.id.iat_contacts);
    ...
    private void initLayout() {
        findViewById(R.id.iat_recognize).setOnClickListener(SpeechRecognizeActivity.this);
...
//        findViewById(R.id.iat_stop).setOnClickListener(VocalRecognizeActivity.this);
//        findViewById(R.id.iat_cancel).setOnClickListener(VocalRecognizeActivity.this);
...
//    };
    ...
    private void printResult(RecognizerResult results) {
        ...
        String[][] clock_words = new String[][]{{"0点","0点", "零点", "0:00"}, {"1点","1点", "一点", "1:00"},
                {"2点","2点", "两点", "2:00"}, {"3点","3点", "三点", "3:00"}, {"4点","4点", "四点", "4:00"},
                {"5点","5点", "五点", "5:00"}, {"6点","6点", "六点", "6:00"}, {"7点","7点", "七点", "7:00"},
                {"8点","8点", "八点", "8:00"}, {"9点","9点", "九点", "9:00"}, {"10点","10点", "十点", "10:00"}
                , {"11点","11点", "十一点", "11:00"}, {"12点","12点", "十二点", "12:00"}, {"13点", "十三点", "13:00", "中午1点"},
