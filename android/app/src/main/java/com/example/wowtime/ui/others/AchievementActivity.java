...
//        }
        ...
        arrContent.add((String)getBaseContext().getResources().getText(R.string.achievement_content_friend_0));//0
        arrContent.add((String)getBaseContext().getResources().getText(R.string.achievement_content_share_0));
        arrContent.add((String)getBaseContext().getResources().getText(R.string.achievement_content_alarm_0));//2
        arrContent.add((String)getBaseContext().getResources().getText(R.string.achievement_content_pomodoro_0));//3
        arrContent.add((String)getBaseContext().getResources().getText(R.string.achievement_content_friend_1));//4
        arrContent.add((String)getBaseContext().getResources().getText(R.string.achievement_content_share_1));//5
        arrContent.add((String)getBaseContext().getResources().getText(R.string.achievement_content_alarm_1));//6
        arrContent.add((String)getBaseContext().getResources().getText(R.string.achievement_content_pomodoro_1));//7
        arrContent.add((String)getBaseContext().getResources().getText(R.string.achievement_content_sleep));//8
        arrContent.add((String)getBaseContext().getResources().getText(R.string.achievement_content_pomodoro_time_0));//9
        arrContent.add((String)getBaseContext().getResources().getText(R.string.achievement_content_pomodoro_time_1));//10
