...
//        creditDetailListItems.add(new CreditDetailListItem(initTime, -3, "DecreaseEvent3"));
        creditDetailListAdapter = new CreditDetailListAdapter(creditDetailListItems,
            ...
            if (message.what == InternetConstant.FETCH) {
                ...
                if (msg.equals("success")) {
                    ...
                    for (int i = 0; i < jsArr.size(); i++) {
                        ...
                        creditDetailListItems.add(new CreditDetailListItem(Timestamp.valueOf(
                                dealDateFormat(jsArr.getJSONObject(i).get("timestamp").toString())),
                                                                           Integer.parseInt(
                                                                                   infos[1]),
                                                                           infos[0]));
                    }
