...
public enum MsgCode {
    ...
    NO_RECOMMEND_FRIEND(MsgConstant.NO_RECOMMEND_FRIEND, MsgConstant.NO_RECOMMEND_FRIEND_MESSAGE),
    ...
    NOT_AUTHENTICATED(MsgConstant.NOT_AUTHENTICATED, MsgConstant.NOT_AUTHENTICATED_MESSAGE);
